...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    // @LINE:20
    def resultJson: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.resultJson",
      """
        function() {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "resultJson"})
        }
      """
    )
